...
class SARSA:
    ...
    def __init__(self, action_space, env, epsilon=RANDOM_PROBABILITY, learning_rate=LEARNING_RATE,
                 discount_factor=TEMPORAL_DISCOUNT_FACTOR, nine_states_mode = NINE_STATES_MODE):
        """Args:
        ...
        self.output_offset = env.output_states_offset
        self.output_state_array = env.output_states_indx
        self.reset()
